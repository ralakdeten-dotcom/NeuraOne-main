...
export const WarehousesTab: React.FC<WarehousesTabProps> = ({ item }) => {
  // Generate unique storage key for this item
      ...
      <div className="space-y-8">
        ...
        <div>
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">MPN</span>
              <span className="text-sm font-medium text-gray-900 dark:text-white">
                {item.mpn || '-'}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">Created Source</span>
              <span className="text-sm font-medium text-gray-900 dark:text-white">CSV</span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">Inventory Account</span>
              <span className="text-sm font-medium text-gray-900 dark:text-white">
                Inventory Asset
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">Inventory Valuation Method</span>
              <span className="text-sm font-medium text-gray-900 dark:text-white">
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">Cost of Goods Sold</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">Sales</span>
            </div>
          </div>
        </div>
      </div>

      {/* Right Column - Image Upload and Stock Information */}
      <div className="space-y-8">
        {/* Image Upload */}
        ...
        <div className="space-y-4">
          <div className="flex justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-400">Initial Stock</span>
            <span className="text-sm font-medium text-gray-900 dark:text-white">
              {(Number(item.initial_stock) || 0).toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-400">Stock on Hand</span>
            <span className="text-sm font-medium text-gray-900 dark:text-white">
              {(Number(item.stock_on_hand) || 0).toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-400">Actual Available Stock</span>
            <span className="text-sm font-medium text-gray-900 dark:text-white">
              {(Number(item.actual_available_stock) || 0).toFixed(2)}
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-sm text-gray-500 dark:text-gray-400">Available Stock</span>
            <span className="text-sm font-medium text-gray-900 dark:text-white">
              {(Number(item.available_stock) || 0).toFixed(2)}
            </span>
          </div>
        </div>
      </div>
