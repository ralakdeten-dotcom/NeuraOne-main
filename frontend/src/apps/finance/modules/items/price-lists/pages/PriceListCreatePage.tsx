...
import { useCreatePriceList, type PriceListFormData } from '../../api/PriceListAPI';
import {
  BasicFormFields,
...
interface PriceListCreatePageProps {
  isOpen?: boolean;
  onClose?: () => void;
}


export const PriceListCreatePage: React.FC<PriceListCreatePageProps> = ({ 
  isOpen = true, 
  onClose 
}) => {
