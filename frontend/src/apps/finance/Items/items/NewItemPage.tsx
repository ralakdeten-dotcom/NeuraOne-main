...
import { useCreateFinanceItem, useUpdateFinanceItem, useFinanceItem, CreateFinanceItemData } from './api'
import { useVendors, useChartOfAccounts, useLocations, useTaxRates } from './apiHooks'
...
export const NewItemPage: React.FC<NewItemPageProps> = ({ 
  isOpen = true, 
  onClose 
}) => {
