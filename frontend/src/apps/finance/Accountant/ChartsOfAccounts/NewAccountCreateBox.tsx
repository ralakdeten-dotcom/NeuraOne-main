...
import { NewFormModalbox } from '@/finance-inventory-shared/createform';
...
interface NewAccountCreateBoxProps {
  isOpen: boolean;
  onClose: () => void;
...
export const NewAccountCreateBox: React.FC<NewAccountCreateBoxProps> = ({
  isOpen,
  onClose,
  onSubmit,
  mode = 'create',
